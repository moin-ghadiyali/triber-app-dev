    ...
    render() {
        return (
            <Tab.Navigator
                ...
                activeColor="#336DAB"
                barStyle={{ margin: 0, backgroundColor: '#fff', paddingLeft: 0, borderTopWidth: 0.5, borderTopColor: '#336DAB' }}
                shifting={false}
                labeled={false}
            >
                <Tab.Screen
                    ...
                    options={{
                        tabBarLabel: 'Home',
                        tabBarIcon: ({ color }) => <Icon name='md-home' color={color} size={25} />
                    }} />
                <Tab.Screen
                    name="Search"
                    component={Search}
                    ...
                    options={{
                        tabBarLabel: 'Search',
                        tabBarIcon: ({ color }) => <Icon name='md-search' color={color} size={25} />
                    }} />
                <Tab.Screen
                    name="Post"
                    component={Post}
                    ...
                    options={{
                        tabBarLabel: 'Post',
                        tabBarIcon: ({ color }) => <Icon name='md-add-circle-outline' color={color} size={25} />
                    }} />
                {/* <Tab.Screen
                    name="Explore"
                    component={Explore}
                    ...
                    options={{
                        tabBarLabel: 'Search',
                        tabBarIcon: ({ color }) => <Icon name='md-globe' color={color} size={25} />
                    }} /> */}
                {/* <Tab.Screen
                    name="Notification"
